...
export class HorizDimensionTool extends Tool
{
	constructor()
	{
		super();
	...
	onMouseDown(e)
	{
		...
		if(this.state === STATE.IDLE){
			...
			this.dimension.type = Shape.HORIZ_DIMENSION;
			this.dimension.geometry = Shape.HORIZ_DIMENSION;
			...
			this.dimension.offset = snap.y - this.startPoint.y;
			this.dimension.update();
	...
	onMouseMove(e){
		if(this.state === STATE.FIRST_POINT && this.dimension){
			...
			this.dimension.offset = data.snapPoint.y - this.startPoint.y;
			this.dimension.update();
			stage.render();
		}
	}
